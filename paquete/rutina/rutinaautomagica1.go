...
func (g *GestorRutinas) GenerarRutinaAutomagica1(nombre string, duracion int, tipo string, dificultad string) (*Rutina, error) {
    todosLosEjercicios := g.gestorEjercicios.ObtenerTodosLosEjercicios()
